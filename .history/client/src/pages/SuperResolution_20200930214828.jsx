        ...
        <div className="vh-70 p-5 pb-0">
          ...
          <div className="container pb-5 mb-3 pt-3">
            ...
            <div className="row pt-3">
              <p className="">
                ...
                Network (SRGAN) is a seminal work that is capable of generating
                realistic textures during single image super-resolution.
                However, the hallucinated details are often accompanied with
                unpleasant artifacts. To further enhance the visual quality, we
                thoroughly study three key components of SRGAN – network
                architecture, adversarial loss and perceptual loss, and improve
                each of them to derive an Enhanced SRGAN (ESRGAN)..."[1]
              </p>
            </div>
          </div>
          <div className="container pb-5">
            <div className="row pt-5 d-flex align-items-end">
              ...
              >
                <h5 className="">from TF-Hub Colab</h5>
              </a>
            </div>
